...
class MovieAppUI(ctk.CTk):
    def __init__(self):
        ...
        self.grid_rowconfigure(4, weight=1) # Rândul cu rezultate se extinde
    ...
    def run_search_logic(self):
        ...
        try:
            # --- MODIFICARE AICI ---
            # Trimitem și RATING-ul la Backend
